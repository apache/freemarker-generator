...
public class ManualTest {
    ...
    private static final String CMD = "-t src/test/templates/manual.ftl examples/data/json/github-users.json examples/data/csv/contract.csv foo=examples/data/csv/contract.csv";
